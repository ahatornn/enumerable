...
//
// The enumerator follows a push-based iteration model where values are
// "yielded" to the consumer function. The iteration can be stopped early
// by the consumer returning false from the yield function.
//
// Type Parameters:
